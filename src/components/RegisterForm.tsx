      ...
      <div className="w-full md:w-[50%] h-form flex flex-col min-h-[1200px] bg-[#fff]">
        <div className="relative border border-yellow-default my-12 mx-8 py-6 px-2">
          ...
          <form className="flex flex-col" onSubmit={handleSubmit(submitData)}>
            <label className="mt-6">Imię*</label>
            <input
              type="text"
            ...
            <label className="mt-6">Nazwisko*</label>
            <input
              type="text"
              className="text-base py-3 px-2 bg-[#E1E1E1]"
              maxLength={20}
            ...
            <label className="mt-6">Nazwa użytkownika*</label>
            <input
              type="text"
              className="text-base py-3 px-2 bg-[#E1E1E1]"
              maxLength={30}
            ...
            <label className="mt-6">Hasło*</label>
            <input
              type="password"
              className="text-base py-3 px-2 bg-[#E1E1E1]"
              maxLength={20}
            ...
            <div className="flex flex-col">
              <div className={`flex flex-col ${selectedOption && "order-2"}`}>
                <label className="mt-6">Numer Pesel</label>
                <input
                  type="text"
                  className="text-base py-3 px-2 bg-[#E1E1E1]"
                  maxLength={11}
